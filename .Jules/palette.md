...
## 2024-05-24 - Disabled Link Button Accessibility
**Learning:** When replacing pointer-events: none with cursor-not-allowed to enable tooltips on disabled links, the href attribute must be removed (href={undefined}) to prevent the link from remaining focusable and clickable.
**Action:** Always remove the href attribute when visually disabling anchor tags.
